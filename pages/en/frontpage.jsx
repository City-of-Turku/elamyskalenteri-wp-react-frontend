...
const Home = ({ elements }) => {
  ...
  return (
    <Layout locale={"en"}>
      <SearchBar />
      <Index locale={"en"} elements={elements} />
...
export const getStaticProps = async () => {
  const res = await fetch(process.env.NEXT_PUBLIC_WP_URL + "/wp-json/wp/v2/pages?slug=frontpage-en&acf_format=standard").then(r => r.json())
